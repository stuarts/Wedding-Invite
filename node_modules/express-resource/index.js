...
var Resource = module.exports = function Resource(name, actions, app, custom_routes) {
  this.name = name;
  this.app = app;
  this.routes = {};
  actions = actions || {};
  ...
  if('function' == typeof custom_routes) {
    custom_routes(this);
  }
...
express.HTTPSServer.prototype.resource = function(name, actions, opts){
  ...
  var res = this.resources[name] = new Resource(name, actions, this, custom_routes);
  return res;
};
